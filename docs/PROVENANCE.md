...
| [obra/superpowers](https://github.com/obra/superpowers) | Inspired by; adapted method | Red-Green-Refactor discipline, systematic debugging gates, and isolated worktree workflows. Separately, the durable progress ledger and the bounded fix loop with mandatory adjudication are adapted from [`subagent-driven-development`](https://github.com/obra/superpowers/blob/b36e0829c6d0140e93cfef2ca599b1b07d4a7797/skills/subagent-driven-development/SKILL.md). Its subagent dispatch and per-role model selection are adapted separately as `/harness-orchestrate`, which depends on one runtime's primitives and is therefore installed only into Claude Code. | [`tdd/SKILL.md`](../core/skills/tdd/SKILL.md), [`bug/SKILL.md`](../core/skills/bug/SKILL.md), [`worktree/SKILL.md`](../core/skills/worktree/SKILL.md), [`implement/SKILL.md`](../core/skills/implement/SKILL.md), [`orchestrate/SKILL.md`](../core/skills/orchestrate/SKILL.md), [`stack-ledger.sh`](../core/scripts/stack-ledger.sh) | [`b36e082`](https://github.com/obra/superpowers/tree/b36e0829c6d0140e93cfef2ca599b1b07d4a7797) | MIT |
